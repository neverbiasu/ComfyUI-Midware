...
const API_URL = "http://localhost:3000/api/plot_image_gen";
const DESC_DIR = path.join(__dirname, "../data/2077NewYoungsTown_2");
const FACE_DIR = path.join(__dirname, "../data/100");
const OUT_DIR = path.join(__dirname, "../data/plot_image");
...
// 获取剧情描述和人脸图片文件名列表（假设都是1.txt/1.png这种编号）
